...
//                        Log.d(TAG, String.valueOf(json_object));
    ...
    public void login(final String username, final String password) {
        ...
        if (Utils.isNetworkAvailable(this)) {
            ...
            VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, Constant.URL_BEFORE_LOGIN + "userLogin", new Response.Listener<NetworkResponse>() {
                @Override
    ...
    public void socialLogin(final String name, final String email, final String id, final String uri, final String userName) {
        ...
        if (Utils.isNetworkAvailable(this)) {
            ...
            final VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, Constant.URL_BEFORE_LOGIN + "userRegistration", new Response.Listener<NetworkResponse>() {
                @Override
                public void onResponse(NetworkResponse response) {
                    String data = new String(response.data);
                    Log.e("Response", data);
