...
public class AboutUsFreelancerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_us_freelancer);
        toolbar();
    ...
    public void getDataAboutUs() {
        ...
        if (Utils.isNetworkAvailable(AboutUsFreelancerActivity.this)) {
                ...
                public void onResponse(NetworkResponse response) {
                    ...
                    try {
                        ...
                        if (status.equals("SUCCESS")) {
                            ...
                            Toast.makeText(AboutUsFreelancerActivity.this, message, Toast.LENGTH_SHORT).show();
                        }
